...
* There are many many useful tools for NLP, and for data science generally, within the **tidyverse** and I strongly recommend you become familiar / take advantage of them. A few specific to text/NLP are discussed below. (A few that are more related to data wrangling / big data computation -- like dplyr, purrr -- are discussed in notebooks for Social Data Analytics 501 (https://burtmonroe.github.io/SoDA501).
