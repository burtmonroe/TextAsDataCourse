---
title: "An Introduction to the Scaling with Wordfish"
output:
  html_document:
    df_print: paged
    toc: yes
...
First, note that the most "governmenty" words are stop words, suggesting the dimension is partially based on length of document. Naturally the government talks more, as the are introducing the budget under debate.
...
We've seen some indicators that a two-topic model can do a similar job. Let's try STM.
...
FREX in fact does seem to indicate similar concepts, at its extremes, to our zeta measure above, in its extremes.

Note, however, that the equivalent of "positions" -- the thetas indicating topic proportion -- and they are also mostly shoved to the extremes.
